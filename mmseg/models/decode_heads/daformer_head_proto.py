...
class DAFormerHeadWithProto(BaseDecodeHead):

    def __init__(self, **kwargs):
        super(DAFormerHeadWithProto, self).__init__(
    ...
    def forward_train(self,
        ...
        """
        # last_feat是最后一层特征，seg_logits是网络输出
        last_feat, seg_logits = self.forward(inputs, return_last_feat=True)
