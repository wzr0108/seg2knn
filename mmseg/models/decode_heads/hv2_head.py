...
class HV2Head(BaseDecodeHead):
    ...
    def forward_train(self,
        ...
        losses = dict()
        # 判断有无分类
        if seg_logit.shape[1] > 3:
            losses = self.losses(seg_logit[:, 3:], gt_semantic_seg, seg_weight)
        ...
        if gt_hv_map is not None:
            ...
            loss_seg = self.criterion2(seg_logit[:, 2:3], gt_fore_background.float())
